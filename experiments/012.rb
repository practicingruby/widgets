...
Ray::Game.new("Experiment #012", :size => [1024,768]) do  
  Drone.create(:pos => [60,255], :speed => 3)
  Drone.create(:pos => [80,255], :speed => 3)
  Drone.create(:pos => [100,255], :speed => 3)


  Widget.create(:pos => [300, 300], :color => Ray::Color.red, :radius => 4)
